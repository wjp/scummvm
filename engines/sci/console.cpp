...
//	registerCmd("classes",			WRAP_METHOD(Console, cmdClasses));	// TODO
	...
	registerCmd("dump_symbols",		WRAP_METHOD(Console, cmdDumpSymbols));
	// Parser
...
bool Console::cmdDumpSymbols(int argc, const char **argv) {
	...
	outFile->writeString(VERSION_STRING(SCI_VERSION_2_1_EARLY));
	outFile->writeString(VERSION_STRING(SCI_VERSION_2_1_MIDDLE));
	outFile->writeString(VERSION_STRING(SCI_VERSION_2_1_LATE));
