...
uint DirtyRectContainer::getSize() {
...
Common::Array<Common::Rect *> DirtyRectContainer::getOptimized() {
	...
	Common::Array<Common::Rect *> queue = _rectArray;
